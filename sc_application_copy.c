...
#include "niagra/app_at_cmd_envelope.h"
#include "niagra/app_custom.h"
#include "niagra/smshandling.h"
#include "niagra/ModemConfig.h"
#include "niagra/livedata.h"
#include "niagra/app_utility.h"
#include "niagra/platform.h"
...
extern void sAPP_Call(void);
extern void sAPP_MqttTask(void);
extern void onesec_timer(void);
extern void mqttTimer_init(void);
extern void SmsDemoInit(void);
extern void FOTA_Task(void);
extern void sAPP_RTC(void);
extern void sAPP_NetlightTask(void);
#ifdef CSD_SUPPORT
...
#ifdef PROJECT_KLYDTU
    extern void kly_Main(void *arg);
    sTaskRef kly_task_ref = NULL;
    sAPI_TaskCreate(&kly_task_ref, NULL, 1024 * 20, 120, "kly main task", kly_Main, NULL);
    printf("kly dtu is running...");
#endif
...
#define appMainStackSize (1024*10)   //(1024*10)
