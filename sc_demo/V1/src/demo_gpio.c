...
#elif SIM7600DM_V101
#include "SIM7600DM_V101_GPIO.h" //SIM7600DM_LCSA/SIM7600DM_LNSA(1603 Module)
...
#include "A7683E_V102_GPIO.h" //A7660E_LAXS(1606 Module)/A7663E_MAXS(1606 Module)/A7683E_LAXS(1606 Module)/A7683E_LLXV(1606 Module)
...
#include "A7680C_V901_GPIO.h" //A7680C_LNXV(1605 Module)//A7680C_MNXV(1605 Module)//A7680C_JNXV(1605 Module) //A7681S_LNXV(1605 Module) //A7681S_LNXY(1605 Module)
#elif SIMCOM_A7681_V201
#include "A7681E_V201_GPIO.h" //A7681E_MNXV(1605 Module)//A7681E_LNXV(1605 Module)//A7681SA-MNXV(1605 Module)//A7681SA-LNXV(1605 Module)//A7665E_MNXV(1605 Module)//A7665E_LNXV(1605 Module)//A7665SA-MNXV(1605 Module)//A7665SA-LNXV(1605 Module)
#elif SIMCOM_A7690C_V605
#include "A7690C_V606_GPIO.h" //A7690C_LNXV(1605 Module)//A7690C_MNXV(1605 Module)//A7690C_JNXV(1605 Module)//A7690C_LNXY(1605 Module)
...
#elif SIMCOM_A7670_V901
#include "A7670_V901_GPIO.h" //A7670C-LNXV(1605 Module)//A7670C-MNXV(1605 Module)//A7670C-JNXV(1605 Module)
#elif SIMCOM_A7682E_V102
#include "A7682EC_V102_GPIO.h" //A7682EC_LASA_1603_R_V102(1603 Module) //A7682E_1603_V102(1603 Module)
#elif SIMCOM_A7679SA_V101
#include "A7679_V101_GPIO.h" //A7679SA_MNXV(1605 Module)
#elif SIMCOM_PCB_A7605_R4_V401
#include "A7605C_V401_GPIO.h" //A7605C_LLXS(1803 Module)
#else
