...
#define SCFW_CAPITALIZED_ATHEAD              ("AT")
#define SCFW_LOWERCASE_ATHEAD                ("at")
#define SCFW_ATTAIL              ("\r\n")
...
int isATCommand(void* data, int length)
{
    ...
    if((strncmp((char *)data, SCFW_CAPITALIZED_ATHEAD, 2) == 0) || (strncmp((char *)data, SCFW_LOWERCASE_ATHEAD, 2) == 0))
    {
