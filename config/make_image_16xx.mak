...
else ifneq (,$(findstring _A7680E_MNXY_1607_V905_OPENSDK_HIK_,_$(SC_MODULE_FULL)_)$(findstring _A7680E_MNXY_1607_V905_HIK_,_$(SC_MODULE_FULL)_))
PREBOOT_CUST_NAME := 2022.11.06_CUS_HIK
else ifneq (,$(findstring _A7682S_LNXV_1602_V801_OPENSDK_KOANPAY_ENORLFSV2_CUSAUDIO_,_$(SC_MODULE_FULL)_))
PREBOOT_CUST_NAME := 2022.11.06_CUS_KOANPAY
endif
...
ifneq (,$(findstring _YAXON_,_${SC_USR_OPT}_))
DSP_SRC_PATH := ${PREBUILD_DIR}/DSP/${ASR_MODEL}/YAXON/DSP_WiFiScan_Reduce_SuLog_Buffer
else
...
ifneq (,$(findstring _A7680C_JNXV_1605_V902_OPENSDK_HXCORE_TTS_ENORLFSV2_,_${SC_MODULE_FULL}_))
PF_SRC_PATH := ${PREBUILD_DIR}/ext_flash/HXCORE
endif
endif
endif
