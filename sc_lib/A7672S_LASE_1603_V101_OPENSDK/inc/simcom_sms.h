...
/****************************************************************************
* FUNCTION
*  sAPI_SmsPreferStorage
*
* DESCRIPTION
*   Query/Set the current memory storage infomation
*
* PARAMETERS
*  [in] mode: Select the mode of query or set storage
*  [in] mem: Select prefer memory storage for SMS messages
*  [out] msgQ: Results will be returned by msgQ
*
* RETURNS
*  SC_SMSReturnCode
*
*****************************************************************************/
SC_SMSReturnCode sAPI_SmsPreferStorage(UINT8 mode, UINT8 mem, sMsgQRef msgQ);
