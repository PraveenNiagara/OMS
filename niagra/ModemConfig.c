...
ModemConfigContext DeviceConfig =
{
	...
	"\"/FOTA/\"",
	"13.235.254.21:1883",   	 		  //MQTT IP
	"niagara",               		  //MQTT USER NAME
	"niagara@123",            		  //MQTT PASSWORD
	"FirmwareToOroApp",                 //MqttPublishTopic
	"OroAppToFirmware",                  //MqttSubscribeTopic
	"FirmwareToOroApp",                  //MqttServerTopic
